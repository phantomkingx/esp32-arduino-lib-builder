...
$SED -i '/CONFIG_FREERTOS_USE_TRACE_FACILITY/c\CONFIG_FREERTOS_USE_TRACE_FACILITY=y' ./sdkconfig
$SED -i '/CONFIG_SUPPORT_STATIC_ALLOCATION/c\CONFIG_SUPPORT_STATIC_ALLOCATION=y' ./sdkconfig
